...
Figure 7: Reconstruction performance comparison between sVaeCom trained on a training set of 5000 **compressed** MNIST images with a WassersteinGan with gradient penality trained on 5000 **ground truth** images. The compressed MNIST images were generated by varying Gaussian measurement matrices with measurement dimension M.
